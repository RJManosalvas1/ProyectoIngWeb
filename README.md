...
> **Nota:** si el comando se queda colgado en "Pulling schema from database...",
> el pooler en modo *Transaction* (puerto 6543) no soporta la introspección de
> `drizzle-kit`. Usa temporalmente el **Session pooler** (puerto 5432) en
> `DATABASE_URL` solo para este comando, y vuelve al *Transaction pooler*
> (6543) para correr la app.
